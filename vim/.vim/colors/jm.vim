...
call s:hi('Normal')
call s:hi('Cursor', s:white, s:lgray)
...
call s:hi('DiffChange', s:white, s:sblue)
...
call s:hi('Statement', s:red, s:default_bg)
call s:hi('PreProc')
call s:hi('String', s:green)
call s:hi('Comment', s:cgray, s:default_bg, s:comment_attr)
call s:hi('Constant')
call s:hi('Type', s:blue, s:default_bg)
